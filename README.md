...
* Join Mentored Sprints server on Discord (invitation-only)
Helpful but not essential:
* Join WiMLDS Slack group
* Join NumPy Slack group
* [Slides from opening zoom presentation](https://drive.google.com/file/d/1lTAnftBXWmYjdDSisyCXzGBXhzwPr2e3/view?usp=sharing)
...
The [slides from the pre-sprint event](https://drive.google.com/file/d/1QOJZbdFuvqxFI6WugqbRg5n_MKpcHdkN/view?usp=sharing).
...
* There is an alternative option to use the numpy gitpod setup.  More information can be found [here](https://numpy.org/devdocs/dev/development_gitpod.html)
